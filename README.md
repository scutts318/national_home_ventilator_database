...
[![Version](https://img.shields.io/badge/version-2.0-blue)](https://scutts318.github.io/national_home_ventilator_database)
[![Status](https://img.shields.io/badge/status-peer%20review-orange)](https://scutts318.github.io/national_home_ventilator_database)
[![Devices](https://img.shields.io/badge/devices-20-green)](https://scutts318.github.io/national_home_ventilator_database)
...
**[Open the tool](https://scutts318.github.io/national_home_ventilator_database)**

> **Current status: Peer review draft.** The database has been built from manufacturer datasheets and clinical manuals but has not yet been independently validated. Please do not use it to guide clinical decisions until validation is complete.
...
1. Primary diagnosis (COPD, NMD slowly progressive, NMD rapidly progressive/MND, OHS, chest wall disorder, SCI)
...
5. Target volume mode requirement
...
**[https://scutts318.github.io/national_home_ventilator_database](https://scutts318.github.io/national_home_ventilator_database)**
...
- Open a [GitHub Issue](https://github.com/scutts318/national_home_ventilator_database/issues)
...
Home Ventilation & Tracheostomy Care Team, Royal Brompton Hospital, Guy's & St Thomas' NHS Foundation Trust
...
Copyright 2025 Steve Cutts, Royal Brompton Hospital, Guy's & St Thomas' NHS Foundation Trust. All rights reserved. This tool and its clinical decision logic are the intellectual property of the author. Reproduction, redistribution, or adaptation without written permission is prohibited.
