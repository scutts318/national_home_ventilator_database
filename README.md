...
It covers **19 devices** across **4 manufacturers**: ResMed, Lowenstein, Breas, and Philips Respironics.
...
**[→ Open the tool](https://scutts318.github.io/uk-home-ventilator-database)**
...
### Device database
- 19 devices across ResMed, Lowenstein, Breas, and Philips Respironics
- Capability grid for each device: battery, invasive capability, life support classification, AVAPs/iVAPS, MPV, volume control modes, O2 compatibility, integrated humidification, remote monitoring platform
...
- Multi-select capability filters (NIV only, Invasive, Life support, Battery, AVAPs/iVAPS, MPV, Remote monitoring, O2 compatible)
...
| Lowenstein | Prisma 30-C, Prisma 30ST, Prisma 40, Prisma 50, Prisma 50-C, Luisa |
| Breas | NIPPY 4, NIPPY 4+, Vivo 1, Vivo 2, Vivo 3, Vivo 45, Vivo 65 |
| Philips Respironics | Trilogy Evo |

> **Note:** ResMed Stellar series is flagged as being discontinued — do not initiate new patients where an alternative is clinically suitable. The Philips Trilogy Evo entry covers the base model only.
...
- ResMed Lumis, Stellar, Astral — ResMed EMEA product brochure (2018)
...
- **EPAP/PEEP ranges and alarm lists** for the ResMed range are pending confirmation from full technical specification sheets — the brochure data used may not capture all sub-model variants.
- **Breas EveryWare** remote monitoring IG approval status varies by NHS Trust — local verification is always required before use for remote monitoring.
- **O2 fields:** No device in the current database has a precision integrated O2 blender. All O2 entries reflect bleed-in ports only. Delivered FiO2 via bleed-in is not controlled or accurately measurable by the ventilator.
...
HCPC: PH89863 · GitHub: [scutts318](https://github.com/scutts318) · LinkedIn: [steve-cutts-147475](https://www.linkedin.com/in/steve-cutts-147475)

---

## Licence

MIT Licence — free to use, adapt, and share with attribution.
...
*Last reviewed: April 2026 · v1.9 · For use by qualified ventilation clinicians only*
